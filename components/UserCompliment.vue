<template>
  <div class="flex flex-col gap-10">
    <div class="flex gap-4">
      ...
      <div class=" bg-contrast p-5 w-[700px] flex flex-col gap-3 rounded-lg">
        <div class="title">Pasha:</div>
        <p>We’ve returned from the battlefield, taking a rest for 3-4 days.</p>
    ...
    <div class="flex gap-4 self-end">
      ...
      <div class="bg-slate-100 p-5 w-[700px] flex flex-col gap-3 rounded-lg">
    ...
    <div class="flex gap-4">
      <!-- <div class="w-[50px] h-[50px] rounded-full bg-contrast"></div> -->
      <div class=" bg-contrast p-7 w-[700px] flex flex-col gap-3 rounded-lg">
        <div class="title">Pasha:</div>
        <p>

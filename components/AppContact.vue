        ...
        <div>
          <div class="my-10 border-y py-8 px-8 max-w-[300px]">
            ...
            <div>
              ...
              <a href="https://g.co/kgs/srHZJYq" target="_blank" class="text-lg ml-5"
                >Open Google Maps</a
              >
            </div>
          </div>
          ...
          <div class="flex gap-4">
            <a
              ...
              target="_blank"
              class="social-link hover:scale-125 transition-all"
              ><IconSocialInstagram />
            </a>
            <a
      ...
      <div>
        ...
        <div class="bg-white bg-opacity-10 p-10 sm:p-5 lg:py-16 lg:px-14 my-5 lg:m-14">
          <form class="flex flex-col">
            ...
            <button
              type="button"
              class="bg-white text-black font-bold py-3 px-16 rounded-md self-end"
            >
              Send
            </button>
          </form>

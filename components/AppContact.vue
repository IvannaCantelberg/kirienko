<template>
    <div id="contact" class="f-h-section text-white p-40">
        ...
        <div class=" grid grid-cols-2 h-[85vh]">
            <div class="flex flex-col justify-evenly">
                ...
                <div>
                    <div class="my-10 border-y py-8 px-8 max-w-[400px]">
                    <div class="mb-6">
                    ...
                    <div class="flex gap-4">
                        <a href="https://www.instagram.com/tatjana_kirienko_textile_art" target="_blank" class="social-link"><IconSocialInstagram /> </a>
                        <a href="https://www.facebook.com/TatjanaKirienkoTextileArtist" target="_blank" class="social-link"><IconSocialFacebook /> </a>
                        <a href="https://www.linkedin.com/in/tatjana-kirienko-14ab0143" target="_blank" class="social-link"><IconSocialLinkedIn /> </a>
                    </div>
                </div>

            </div>         
            <div>
                <h3 class="title text-2xl mb-4">Have a question ?</h3>
                <h3 class="title text-2xl mb-4">Want to join to the project?</h3>

                <div class="bg-white bg-opacity-10 py-16 px-14 m-14">
                    <form class="flex flex-col">
                        <div class="grid gap-6 mb-10">
                            ...
                            <div>
                                <label for="fiemailrst_name" class="block mb-2 text-sm font-medium">Email *</label>
                        ...
                        <button type="button" class="bg-white text-black font-bold py-3 px-16 rounded-md self-end">Send</button>
                    </form>
                </div>
            </div>
        </div>
